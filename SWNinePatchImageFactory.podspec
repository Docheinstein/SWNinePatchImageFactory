...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Alex Steiner"
  # s.authors            = { "Alex Steiner" => "privat@alexsteiner.de" }
  # s.social_media_url   = "http://twitter.com/Alex Steiner"
  ...
  s.source_files  = "SWNinePatchImageFactorySample/SWNinePatchImageFactory", "SWNinePatchImageFactorySample/SWNinePatchImageFactory/**/*.{h,m}"
  s.exclude_files = "SWNinePatchImageFactorySample/SWNinePatchImageFactorySample"

  # s.public_header_files = "SWNinePatchImageFactorySample/SWNinePatchImageFactory/**/*.h"
